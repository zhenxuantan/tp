...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    private Path taskRecordsFilePath = Paths.get("data", "taskrecords.json");
    ...
    public void resetData(ReadOnlyUserPrefs newUserPrefs) {
        ...
        setTaskRecordsFilePath(newUserPrefs.getTaskRecordsFilePath());
    }
    ...
    public void setTaskRecordsFilePath(Path taskRecordsFilePath) {
        requireNonNull(taskRecordsFilePath);
        this.taskRecordsFilePath = taskRecordsFilePath;
    }
