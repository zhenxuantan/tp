...
public class ContactListParserTest {
    ...
    public void parseCommand_clear() throws Exception {
        assertTrue(parser.parseCommand(GroupCommand.COMMAND_WORD) instanceof ClearCommand);
        assertTrue(parser.parseCommand(GroupCommand.COMMAND_WORD + " 3") instanceof ClearCommand);
    }
