...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(INVALID_NAME,
                VALID_GROUP, VALID_PHONE, VALID_EMAIL, VALID_TELEGRAM, VALID_GITHUB);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME,
                VALID_GROUP, INVALID_PHONE, VALID_EMAIL, VALID_TELEGRAM, VALID_GITHUB);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME,
                VALID_GROUP, null, VALID_EMAIL, VALID_TELEGRAM, VALID_GITHUB);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME,
                VALID_GROUP, VALID_PHONE, INVALID_EMAIL, VALID_TELEGRAM, VALID_GITHUB);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_GROUP, VALID_PHONE, null,
    ...
    public void toModelType_invalidGroup_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, INVALID_GROUP, VALID_PHONE, VALID_EMAIL,
                VALID_TELEGRAM, VALID_GITHUB);
